...
export function AuthShell({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-6xl flex-col gap-8 lg:flex-row lg:items-stretch">
        ...
        {/* RIGHT PANEL */}
        <div className="flex items-center justify-center max-sm:h-screen lg:h-[calc(100vh-5rem)] lg:w-[48%] lg:overflow-y-auto lg:pr-1 no-scrollbar">
          <Card className="w-full max-w-md rounded-[2rem] border bg-background/80 p-6 shadow-2xl backdrop-blur-xl sm:p-8 max-lg:border-none max-lg:bg-transparent max-lg:shadow-none">
