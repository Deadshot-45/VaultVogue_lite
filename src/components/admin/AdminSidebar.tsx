  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute -right-3 top-20 z-10 flex h-6 w-6 items-center justify-center rounded-full border shadow-sm transition-colors duration-200 hover:border-[var(--gold)] cursor-pointer"
        style={{
