...
import { AuthResponse, authService } from "@/lib/services/authServices";
...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // 1. Validate Form Fields via Zod Schema
    ...
    try {
      // 2. Perform POST request via centralized authService
      const loginPromise = authService.adminSignIn(
        parsed.data.email,
